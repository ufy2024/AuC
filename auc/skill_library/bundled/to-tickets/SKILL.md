...
description: Break a plan, spec, or the current conversation into a set of tracer-bullet
  ...
  — edges as text in a local file, or native blocking links on a real tracker.
triggers:
- to-tickets
- break
- plan
...
source: bundled
builtin: true
source_url: https://github.com/mattpocock/skills/blob/main/skills/engineering/to-tickets/SKILL.md
