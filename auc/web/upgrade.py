...
from auc.version_check import PYPI_PACKAGE, fetch_latest_version, is_newer, release_info
...
def run_pip_upgrade(*, timeout: float = 180.0) -> dict[str, Any]:
    ...
    ok = proc.returncode == 0 and bool(_PIP_OK.search(output))
